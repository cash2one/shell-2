...
to="jianqiangni@anjuke.com pyzhao@anjuke.com lianjunlv@anjuke.com lvlianjun1988@139.com"
email_title=""
email_subject="mss异常"
email_content=$1
for t in $to
...
init 10.10.9.76 8965,8966,8967 /data1/logs/monitor_log/mss_error.log
